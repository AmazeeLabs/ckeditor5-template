...
describe( 'Placeholder', () => {
		...
		return ClassicTestEditor
			.create( editorElement, {
				...
				templates: {
					...
					placeholder: {
						label: 'Placeholder',
						template: '<div class="placeholder"><div ck-type="placeholder" ck-allowed="a b"></div></div>',
					}
				}
			} )
			.then( newEditor => {
	...
	it( 'is upcast to a placeholder', () => {
		...
		expect(getModelData(model)).to.equal('[<ck__placeholder><ck__placeholder__child0></ck__placeholder__child0></ck__placeholder>]');
	} );
